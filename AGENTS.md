...
3. [App architecture](docs/APP_ARCHITECTURE.md) — layer boundaries and reusable UI structure.
4. [Feature roadmap](docs/FEATURE_ROADMAP.md) — current phase, scope, and continuation point.
...
- Follow `docs/APP_ARCHITECTURE.md`: screens compose shared UI and delegate game/persistence work to the game layer.
